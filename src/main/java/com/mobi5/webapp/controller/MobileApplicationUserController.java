 ...
 */
@Path("/api/v1/mobile-application-user")
public class MobileApplicationUserController {
     ...
     */
    @POST
    public Response createMobileApplicationUser(@HeaderParam("Authorization") String authorization, MobileApplicationUser mobileApplicationUser) throws URISyntaxException {
     ...
     */
    @PUT
    public Response updateMobileApplicationUser(@HeaderParam("Authorization") String authorization, MobileApplicationUser mobileApplicationUser) throws URISyntaxException {
     ...
     */
    @GET
    public List<MobileApplicationUser> getAllMobileApplicationUsers(@HeaderParam("Authorization") String authorization) {
    ...
    @Path("/{id}")
    @GET
    public Response getMobileApplicationUser(@HeaderParam("Authorization") String authorization, @PathParam("id") Long id) {
    ...
    @Path("/{id}")
    @DELETE
    public Response removeMobileApplicationUser(@HeaderParam("Authorization") String authorization, @PathParam("id") Long id) {
